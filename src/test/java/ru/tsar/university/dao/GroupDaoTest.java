...
class GroupDaoTest {
	...
	void givenNewGroup_whenCreate_thenCreated() {
		Group expected = new Group.GroupBuilder().setName("T7-09").build();
	...
	void givenId_whenGetById_thenGroupFound() {
		Group expected = new Group.GroupBuilder().setId(2).setName("A7-98").build();
	...
	void givenGroups_whenGetAll_thenGroupsListFound() {
		Group first = new Group.GroupBuilder().setId(1).setName("T7-09").build();
		Group second = new Group.GroupBuilder().setId(2).setName("A7-98").build();
